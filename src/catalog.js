...
const fieldAliases = {
  ...
  category: ["category", "study area", "field", "discipline", "subject area"],
  ...
  qsRanking: ["qs ranking", "qs rank", "ranking", "university ranking", "rank"],
...
function rawCatalogProgram(row, index, source) {
  ...
  return {
    ...
    category: rowValue(row, fieldAliases.category),
    ...
    qsRanking: rowValue(row, fieldAliases.qsRanking),
